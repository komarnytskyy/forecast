...
const Forecast: FC<forecastProps> = ({ data }) => {
  ...
  return (
    <div
      className="w-full md:max-w-[500px] py-4 
        md:py-4 md:px-10 lg:px-24 h-full lg:h-auto 
    ...
    >
      <div className="mx-auto w-[300px]">
        ...
        <section className="flex justify-between flex-wrap text-zinc-700">
          <div
            className="w-[140px] text-xs font-bold 
            flex flex-col items-center bg-white/20 
